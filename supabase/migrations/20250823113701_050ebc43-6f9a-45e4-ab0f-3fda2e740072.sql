...
-- Sample listings (fixing the constraint: live + suspended <= apps)
INSERT INTO public.listings (seller_id, title, country, year, price_usd, verified_with_id, deal_type, apps, live, suspended, play_url, whatsapp) VALUES
  ('11111111-1111-1111-1111-111111111111', 'Google Play Account', 'Morocco', 2020, 1700, TRUE, 'instant', 7, 5, 2, 'https://play.google.com/store/apps/dev?id=5258410538530331508', '+212612345000'),
  ...
  ('33333333-3333-3333-3333-333333333333', 'Google Play Account', 'India', 2019, 950, FALSE, '7day', 5, 3, 2, 'https://play.google.com/store/apps/dev?id=6091752745250081031', '+91987654321'),
